<template>
  <div class="bg-linear-to-br from-blue-50 via-white to-purple-50 pt-20 pb-16 min-h-screen font-poppins">
    <div class="container mx-auto px-4 flex flex-col lg:flex-row gap-8">
      ...
      <div class="w-full lg:w-2/3 xl:w-3/4">
        ...
        <div v-else-if="course" class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-8 mb-8">
          <div class="relative mb-6">
            ...
            />
            <div class="absolute inset-0 bg-linear-to-t from-black/60 to-transparent rounded-xl"></div>
          </div>
          
          <!-- Course Title -->
          <h1 class="text-4xl font-bold mb-4 bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
            {{ course.title }}
          </h1>
      ...
      <aside class="w-full lg:w-1/3 xl:w-1/4">
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-6 mb-8 sticky top-24">
          <div class="text-2xl font-bold bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-4">
            Info Kursus
          </div>
          ...
          <button 
            @click="handleJoin"
            class="mt-8 w-full py-4 bg-linear-to-r from-blue-600 to-purple-600 text-white rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300"
          >
