...
export default defineEventHandler(async (event) => {
  ...
  if (method === 'PUT') {
    ...
    try {
      ...
      // Delete existing aspects, questions, and options (cascade delete will handle related records)
  ...
  if (method === 'DELETE') {
    // Delete survey instrument by ID (cascade delete will handle related records)
    try {
